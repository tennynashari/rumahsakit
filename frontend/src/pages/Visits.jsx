...
const Visits = () => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      ...
      IN_PROGRESS: { label: 'Berlangsung', className: 'bg-yellow-100 text-yellow-800' },
      COMPLETED: { label: 'Selesai', className: 'bg-green-100 text-green-800' },
      CANCELLED: { label: 'Dibatalkan', className: 'bg-red-100 text-red-800' },
      NO_SHOW: { label: 'Tidak Hadir', className: 'bg-gray-100 text-gray-800' }
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Kunjungan Pasien</h1>
          <p className="text-sm text-gray-600">Kelola data kunjungan dan jadwal pasien</p>
        </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Tidak ada data kunjungan</p>
          </div>
        ) : (
          <>
